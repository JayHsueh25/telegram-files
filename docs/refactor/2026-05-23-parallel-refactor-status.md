...
| --- | --- | --- | --- | --- | --- |
| A | reviewed and partially merged | `.worktrees/lane-a-route-support` | `api/src/main/java/telegram/files/HttpVerticle.java`, `api/src/main/java/telegram/files/http/**` | in_progress | Task 1A route support helpers merged via `merge: lane a route support helpers`; `RouteSupportTest` passes |
