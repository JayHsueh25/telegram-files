...
| C | unassigned | `.worktrees/parallel-system-refactor` | `api/src/main/java/telegram/files/TelegramVerticle.java`, `api/src/main/java/telegram/files/telegram/**` | ready | Starts after Lane A/B |
...
| F | unassigned | `.worktrees/parallel-system-refactor` | API contract files | ready | Starts after Lane A/B/D |
